...
type ListPositionRepository interface {
	...
	CreatOrUpdate(boardPublicID string, listOrder []uuid.UUID) error
...
func (r *listPositionRepository) CreatOrUpdate(boardPublicID string, listOrder []uuid.UUID) error {
