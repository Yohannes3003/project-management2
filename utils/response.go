...
type PaginationMeta struct {
	...
	Filter string `json: "filter" example:"nama=yohannes"`
	Sort string `json: "sort" example:"-id"`
}

func Succes(c *fiber.Ctx, message string, data interface{}) error {
...
func SuccesPagination(c *fiber.Ctx, message string, data interface{}, meta PaginationMeta) error {
